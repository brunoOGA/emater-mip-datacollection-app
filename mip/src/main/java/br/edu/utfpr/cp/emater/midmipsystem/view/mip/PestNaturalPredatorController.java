...
@Component
@RequestScope
public class PestNaturalPredatorController extends PestDisease implements ICRUDController<PestDisease> {

    private final PestDiseaseService pestDiseaseService;
    
    @Autowired
    public PestNaturalPredatorController(PestDiseaseService aPestDiseaseService) {
