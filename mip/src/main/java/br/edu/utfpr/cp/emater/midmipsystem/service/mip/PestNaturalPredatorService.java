...
@Component
public class PestNaturalPredatorService implements ICRUDService<PestDisease> {

    private final PestDiseaseRepository pestDiseaseRepository;

    @Autowired
    public PestNaturalPredatorService(PestDiseaseRepository aPestDiseaseRepository) {
